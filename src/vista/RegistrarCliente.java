...
public class RegistrarCliente extends javax.swing.JFrame {
    ...
    public RegistrarCliente() {
        ...
        initComponents();
        TextoGuia.aplicarTextoGuia(CorreoCliente, "Ingresa tu correo");
        TextoGuia.aplicarTextoGuia(nombreCliente, "Ingresa tu nombre");
        TextoGuia.aplicarTextoGuia(usuarioCliente, "Ingresa tu usuario");
        TextoGuia.aplicarTextoGuia(PasswordCliente, "Ingresa tu contraseña");
...
private void llenarFecha(){
    ...
    private void RegistrarNuevoClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegistrarNuevoClienteActionPerformed
        ...
        String user = usuarioCliente.getText();
        ...
        // Archivo JSON
        Cliente nuevoCliente = new Cliente(tipo, nombre.toLowerCase(), user, correo, password, fechaNacimiento);
